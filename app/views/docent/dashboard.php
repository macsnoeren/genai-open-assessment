                ...
                <tr>
                  ...
                  <td class="text-end">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <a href="/?action=exam_duplicate&id=<?= $exam['id'] ?>" class="btn btn-outline-warning" onclick="return confirm('Weet je zeker dat je deze toets wilt dupliceren inclusief alle antwoorden? De AI-feedback wordt gewist, docent-feedback blijft behouden.')" title="Dupliceren">Dupliceren</a>
