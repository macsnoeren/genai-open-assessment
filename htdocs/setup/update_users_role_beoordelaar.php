<?php
// Dit script update de users tabel om de 'beoordelaar' rol toe te staan.
// Run dit via de browser: /setup/update_users_role_beoordelaar.php
...
try {
    ...
    echo "Start migratie voor rol 'beoordelaar'...<br>";
    ...
    echo "✅ Succes! De users tabel is bijgewerkt en ondersteunt nu de rol 'beoordelaar'.<br>";
